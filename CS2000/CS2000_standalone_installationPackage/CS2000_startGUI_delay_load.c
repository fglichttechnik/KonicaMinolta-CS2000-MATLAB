 ...
 */
FARPROC WINAPI CS2000_startGUIDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = CS2000_startGUIDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = CS2000_startGUIDelayLoadWin32FailureHook;
#endif
